...
<div class="w3-content" style="max-width:2000px;margin-top:46px">
    ...
    <div id="div1">
        <div id="test-text">
            <div>
                <p id="aa"><a href="#">قانونية</a> هي منصة تقدم خدمات <a href="#">ساندة للقانونيين</a> وذلك بتوفير قاعدة
                    بياصنات نوعية تشمل
                    أكثر من ثالثين ألف مستند خاصا
                    &nbsp; خاصاّ<br>ووثيقة
                    <a href="#" قانونية></a> متعلقة بالنظام السعودي، تتضمن قاعدة البيانات &nbsp; <br> حكام وقرارات
                    وأنظمة ولوائح
                    <a href="#"> وتعاميم </a> ومبادئ ونماذج
                    <a href="#"> استرشادية</a> لعقود ومذكرات </p>
                <p><br></p>
                <table border="1" cellpadding="1" cellspacing="1">
                    ...
                    <tr>
                        ...
                        <th colspan="5" style="text-align:center">الرسم مقدار</th>
                    ...
                    <tr>
                        <td>١</td>
                        <td colspan="7" rowspan="1"><strong>المباني انشاء تراخيص اصدار</strong></td>
                    </tr>
                    <tr>
                        <td>١-١</td>
                        <td>المباني السكنية</td>
                        <td style="text-align:center">٣٫٠٠</td>
                        <td style="text-align:center">٤٫٠٠</td>
                        <td style="text-align:center">٥٫٠٠</td>
                        <td style="text-align:center">٦٫٠٠</td>
                        <td style="text-align:center">٧٫٠٠</td>
                        <td>لكل متر مربع</td>
                    </tr>
                    </tbody>
                </table>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#test-text").mouseup(function (e2) {
            ...
            //window.location.href = "http://127.0.0.1:8000/testUrl?startPoint="+startPoint+"&endPoint="+endPoint+"&selectedText="+selectedText;
        });
